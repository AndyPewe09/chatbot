...
class ChatGUI:
    ...
    def add_bot_message(self, message):
        ...
        myVoice = gTTS(message,lang="id",slow=False)
        myVoice.save("chatbot/text_to_speech/response.mp3")
        playsound("chatbot/text_to_speech/response.mp3")
        os.remove("chatbot/text_to_speech/response.mp3")
